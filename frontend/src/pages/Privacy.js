...
const Privacy = () => {
  return (
    <div>
        ...
        <p>
        PRIVACY POLICY FOR VEHICLE STATE TAX APP
        </p>
        ...
        <ol>
            <li>
            Personal Data: We collect the information you give us while using our services. Personal Information for this privacy policy is any information that directly or indirectly identifies you, which is included but not limited to: a) Your Name; b) Vehicle Number.
            </li>
        </ol>
        ...
        <p>
        ii. Posting of Revised Privacy Policy: If there are any material changes to this privacy policy, VEHICLE STATE TAX may notify you by email or as otherwise required by applicable law. We will post any adjustments to the privacy policy on this app, and the revised version will be effective immediately when it is posted (or upon notice as applicable). If you are concerned about how your information is used, bookmark this page and read this privacy policy periodically.
        </p>
